...
class ApiService {
  // Points at backend/. Web (Chrome) uses localhost directly; the Android
  // emulator needs 10.0.2.2 as its alias for the host machine's localhost.
  // Override at build/run time with --dart-define=API_BASE_URL=... for a
  // physical device (LAN IP) or the deployed Render URL in production.
