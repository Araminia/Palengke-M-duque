...
export const Route = createFileRoute("/checkout")({ head: () => ({ meta: [{ title: "Checkout — Palengke.mq" }, { name: "description", content: "Choose delivery or pickup and place your market order." }, { property: "og:title", content: "Checkout — Palengke.mq" }, { property: "og:description", content: "Simple checkout for your public-market order." }, { property: "og:type", content: "website" }, { name: "twitter:card", content: "summary" }] }), component: CheckoutPage });
