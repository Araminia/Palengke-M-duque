...
export const Route = createFileRoute("/vendors")({ head: () => ({ meta: [{ title: "Local Vendors — Palengke.mq" }, { name: "description", content: "Meet trusted vendors at Bagong Palengke ng San Jose." }, { property: "og:title", content: "Local Vendors — Palengke.mq" }, { property: "og:description", content: "Shop directly from verified local market stalls." }, { property: "og:type", content: "website" }, { name: "twitter:card", content: "summary_large_image" }] }), component: VendorsPage });
