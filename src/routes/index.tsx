...
function Index() {
  ...
  return (
    <>
      ...
      <footer className="bg-foreground text-background"><div className="mx-auto grid max-w-7xl gap-8 px-4 py-10 sm:grid-cols-3 sm:px-6"><div><h2 className="font-display text-xl font-bold">Palengke<span className="text-market-gold">.ph</span></h2><p className="mt-2 text-xs text-background/70">Ang bagong paraan ng pamamalengke.</p></div><div><b className="text-sm">Bagong Palengke ng Marinduque</b><p className="mt-2 text-xs text-background/70">Open daily · 5:00 AM–7:00 PM</p></div><div><b className="text-sm">For vendors</b><p className="mt-2 text-xs text-background/70">Grow your stall online and reach more suki.</p><Button asChild size="sm" className="mt-3"><Link to="/vendor-dashboard">Vendor dashboard</Link></Button></div></div></footer>
    </>
  );
}
