...
export const Route = createFileRoute("/categories")({ head: () => ({ meta: [{ title: "Market Categories — Palengke.mq" }, { name: "description", content: "Browse fresh public-market products by category." }, { property: "og:title", content: "Market Categories — Palengke.mq" }, { property: "og:description", content: "Fresh produce, seafood, meat, rice and more from local vendors." }, { property: "og:type", content: "website" }, { name: "twitter:card", content: "summary_large_image" }] }), component: CategoriesPage });
